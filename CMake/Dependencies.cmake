...
if(AETHERCORE_ENABLE_IMGUI)
    ...
    if(imgui_ADDED)
        ...
        # VK_NO_PROTOTYPES: tell imgui_impl_vulkan to use the loader-function-pointer
        # approach instead of calling Vulkan functions directly (required because we
        # use volk which redefines the global Vk* symbols).
