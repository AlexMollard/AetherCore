...
namespace aether
{
	...
	public:
		...
		explicit CommandRecorder(VkCommandBuffer cmd)
		      : m_cmd(cmd)
		{
		}
		...
		static void SetDebugLabelFunctions(PFN_vkCmdBeginDebugUtilsLabelEXT beginFn, PFN_vkCmdEndDebugUtilsLabelEXT endFn);
