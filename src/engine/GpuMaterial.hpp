...
namespace aether
{
	...
	//   offset 32 : vec4    emissiveFactor           (16)   xyz = emissive RGB, w unused
	//   offset 48 : uint32  flags                    ( 4)
	//   offset 52 : uint32  albedoSlot               ( 4)
	//   offset 56 : uint32  normalSlot               ( 4)
	//   offset 60 : uint32  metallicRoughnessSlot    ( 4)
	//   offset 64 : uint32  occlusionSlot            ( 4)
	//   offset 68 : uint32  emissiveSlot             ( 4)
	//   offset 72 : uint32  _pad[2]                  ( 8)
	//   Total: 80 bytes
