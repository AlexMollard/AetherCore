...
namespace aether::app
{
	...
	// This separates game logic from the UI layer, making inter-system
	// communication cleaner (AI system, movement system, etc. all operate on the
	// world via systems).
	...
	public:
		...
		[[nodiscard]] std::size_t GetModelEntityCount() const
		{
			return m_modelEntityCount;
		}

		[[nodiscard]] std::size_t GetModelPrimitiveCount() const
		{
			return m_model ? m_model->primitives.size() : 0;
		}
