...
namespace aether::app
{
	...
	public:
		...
		void SetTimeOfDay(float hours) { m_time = hours * 3600.0f; }
		[[nodiscard]] float GetTimeOfDay() const { return std::fmod(m_time / 3600.0f, 24.0f); }

		void SetTimeSpeed(float secondsPerSecond) { m_timeSpeed = secondsPerSecond; }
