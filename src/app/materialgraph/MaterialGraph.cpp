...
namespace aether::editor
{
	...
	std::string GenerateMaterialShader(const MaterialGraph& graph, std::string& error)
	{
		...
		// scene looking like the materials around it. Still missing next to the standard
		// shader: fog and the occlusion texture, both of which need inputs the graph's Output
