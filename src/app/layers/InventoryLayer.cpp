...
namespace aether::app
{
	...
	static constexpr FakeItem kItems[kInventorySlots] = {
	        // Row 1 - assorted loot
	        {.rarity = kRarityLegendary, .quantity = 1},
	        {.rarity = kRarityAscended, .quantity = 1},
	        {.rarity = kRarityExotic, .quantity = 1},
	        {.rarity = kRarityRare, .quantity = 3},
	        {.rarity = kRarityMasterwork, .quantity = 5},
	        {.rarity = kRarityFine, .quantity = 12},
	        {.rarity = kRarityJunk, .quantity = 50},
	        {.rarity = {}, .quantity = 0}, // empty

	        // Row 2
	        {.rarity = kRarityExotic, .quantity = 1},
	        {.rarity = kRarityRare, .quantity = 2},
	        {.rarity = kRarityMasterwork, .quantity = 8},
	        {.rarity = kRarityFine, .quantity = 25},
	        {.rarity = kRarityFine, .quantity = 17},
	        {.rarity = kRarityJunk, .quantity = 100},
	        {.rarity = {}, .quantity = 0},
	        {.rarity = {}, .quantity = 0},

	        // Row 3
	        {.rarity = kRarityAscended, .quantity = 1},
	        {.rarity = kRarityRare, .quantity = 1},
	        {.rarity = kRarityRare, .quantity = 1},
	        {.rarity = kRarityMasterwork, .quantity = 3},
	        {.rarity = kRarityMasterwork, .quantity = 3},
	        {.rarity = kRarityFine, .quantity = 42},
	        {.rarity = kRarityJunk, .quantity = 99},
	        {.rarity = {}, .quantity = 0},

	        // Row 4
	        {.rarity = kRarityExotic, .quantity = 1},
	        {.rarity = kRarityExotic, .quantity = 1},
	        {.rarity = kRarityRare, .quantity = 4},
	        {.rarity = kRarityFine, .quantity = 30},
	        {.rarity = kRarityFine, .quantity = 7},
	        {.rarity = kRarityJunk, .quantity = 18},
	        {.rarity = {}, .quantity = 0},
	        {.rarity = {}, .quantity = 0},
	        ...
	        {.rarity = kRarityLegendary, .quantity = 1},
	        {.rarity = kRarityAscended, .quantity = 1},
	        {.rarity = kRarityMasterwork, .quantity = 2},
	        {.rarity = kRarityMasterwork, .quantity = 6},
	        {.rarity = kRarityFine, .quantity = 11},
	        {.rarity = kRarityJunk, .quantity = 33},
	        {.rarity = {}, .quantity = 0},
	        {.rarity = {}, .quantity = 0},

	        // Row 6 - mostly empty (end of bag)
	        {.rarity = kRarityRare, .quantity = 1},
	        {.rarity = kRarityFine, .quantity = 9},
	        {.rarity = {}, .quantity = 0},
	        {.rarity = {}, .quantity = 0},
	        {.rarity = {}, .quantity = 0},
	        {.rarity = {}, .quantity = 0},
